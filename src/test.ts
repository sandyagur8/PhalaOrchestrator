...
// curl https://agents.phala.network/vaults -H 'Content-Type: application/json' -d '{"cid": "QmVFVHTAoSUuf6sGGtVQHkCjXYDHfjiaX4rd6vStJSBYFD/0", "data": {"openaiApiKey": "sk-proj-3RlirrJw5hQAjeW628LuT3BlbkFJVc2C9tAAWVcqqDo8UTLo"}}'

//QmVFVHTAoSUuf6sGGtVQHkCjXYDHfjiaX4rd6vStJSBYFD/0
...
async function test() {
    const getResult = await execute({
        ...
        queries: {
            chatQuery: ["How to deploy a ERC20 token in starknet"],
            openAiModel: ["gpt-4o"]
        },
